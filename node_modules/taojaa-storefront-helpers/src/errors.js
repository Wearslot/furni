...
const errorMessages = {
    ...
    '500': `<p> Please forgive the inconvenience. <br />
            We are currently trying to fix the problem. </p>
            <p>We'll be back up soon!</p>`,



    '403': ` <p>Please forgive the inconvenience. <br />
            This site is unavailable at the moment.</p>
            <p>Kindly contact owner or contact support.</p>`,


    '404': ` <p>The requested resource/domain does not exist..</p>
            <p>Kindly contact owner or contact support.</p>`
...
const errorSymbols = {
    ...
    '500': `<svg width="126px" height="126px" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg"
                transform="rotate(0)">
    ...
    '403': `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		...
		C84.573,16.331,86.05,20.549,84.365,24.062z" fill="none" stroke="#8a50fc" />
    ...
    '404': `<svg width="126px" height="126px" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg"
                transform="rotate(0)">
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC"
                    stroke-width="0.096"></g>
...
exports.errorResponse = (type) => {

    const head = `<head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>${errorTitles[type]}</title>
        <style>
...
exports.developmentErrorResponse = (error) => {
    return `<!DOCTYPE html><html lang="en"><head><title>${error}</title></head>
        <body><p>${error}</p></body>
        </html>`
}